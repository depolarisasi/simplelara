        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3"> 
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">New Role</button>
                </div>
                <!--end::Actions-->
            </div>
            <!--end::Toolbar wrapper-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-flush h-md-100">
                                    ...
                                    <div class="card-footer flex-wrap pt-0"> 
                                        <a href="{{ url('administrator/role/edit/'.$role->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit p-0"></i></a>
                                        <button class="btn btn-danger btn-sm delete-role" data-id="{{ $role->id }}"><i class="fas fa-trash p-0"></i></button>
	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<form action="{{url('administrator/role/store')}}" method="POST">
					@csrf
        ...
        $(document).on('click', '.delete-role', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('administrator/role/delete') }}/" + roleId,
                        type: 'GET',
